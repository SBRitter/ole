 ...
 */
public class OleAccessionNumberTypeLookupableImpl extends LookupableImpl {
    ...
    protected String getActionUrlHref(LookupForm lookupForm, Object dataObject, String methodToCall,
        ...
        String maintenanceMapping = "accessionNumberTypeMaintenance";
    ...
    protected List<?> getSearchResults(LookupForm form, Map<String, String> searchCriteria, boolean unbounded) {
        List<?> searchResults;
        List<OleAccessionNumberType> finalSearchResult = new ArrayList<OleAccessionNumberType>();
        List<OleAccessionNumberType> oleInstanceItemType = new ArrayList<OleAccessionNumberType>();

        oleInstanceItemType = (List<OleAccessionNumberType>) super.getSearchResults(form, searchCriteria, unbounded);
